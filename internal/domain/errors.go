...
var (
	...
	ErrIdempotencyKeyRequired = errors.New("заголовок Idempotency-Key обязателен")
	ErrInvalidIdempotencyKey  = errors.New("невалидный Idempotency-Key")
	ErrIdempotencyConflict    = errors.New("Idempotency-Key уже использован с другими параметрами")
	ErrIdempotencyInProgress  = errors.New("перевод с таким Idempotency-Key ещё выполняется")
